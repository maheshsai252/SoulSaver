 ...
 * @author somes
 */
public class ForecasterListOfPharmacyRequests extends javax.swing.JPanel {

    /**
     * Creates new form ForecasterListOfPharmacyRequests
     */
   ForecastOrgAdmin r;
...
JSplitPane mainPanel;
   ...
   ForecastRequestService ras = new  ForecastRequestService();
    public ForecasterListOfPharmacyRequests(ForecastOrgAdmin r, JSplitPane mainPanel,ArrayList<Component> al) {
        initComponents();
    ...
    void addData() {
        ...
        ArrayList<ForecastRequests> reqs = ras.getOrgPharmacyForecastRequestss(r.getForecastorgid());
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Forecaster List of Pharmacy Requests");
