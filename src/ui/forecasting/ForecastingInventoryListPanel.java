 ...
 * @author somes
 */
public class ForecastingInventoryListPanel extends javax.swing.JPanel {

    /**
     * Creates new form ForecastingInventoryListPanel
     */
    
JSplitPane mainPanel;
    ArrayList<Component> al;
     InventoryItemService ps = new InventoryItemService();
    public ForecastingInventoryListPanel(JSplitPane mainPanel,ArrayList<Component> al) {
        initComponents();
        ...
        for(Map.Entry<String, Double> s : reqs.entrySet()) {
                ...
                InventoryItem h = ps.getInventoryItem(s.getKey());
                row[0] = h;
                row[1] = s.getValue();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Revenue of Inventories");
    ...
    private void btnFullfillActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnFullfillActionPerformed
        ...
        ForecastingInventoryPanel panel = new ForecastingInventoryPanel( item,this.mainPanel,al);
