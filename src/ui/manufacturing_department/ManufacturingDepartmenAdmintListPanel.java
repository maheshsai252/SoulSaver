 ...
 * @author madhav
 */
public class ManufacturingDepartmenAdmintListPanel extends javax.swing.JPanel {

    /**
     * Creates new form ManufacturingDepartmenAdmintListPanel
     */
    JSplitPane mainPanel;
    ArrayList<Component> al;
    ManufacturingDepartmentService hs = new ManufacturingDepartmentService();
    public ManufacturingDepartmenAdmintListPanel( JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
    ...
    void addData() {
        ArrayList<ManufacturingDepartment> hospitals = hs.getAllManufacturingDepartments();
