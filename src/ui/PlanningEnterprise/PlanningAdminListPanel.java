 ...
 * @author maheshsai
 */
public class PlanningAdminListPanel extends javax.swing.JPanel {

    /**
     * Creates new form PlanningAdminListPanel
     */
       JSplitPane mainPanel;
    ArrayList<Component> al;
    PlanningAdminService hs = new PlanningAdminService();
    public PlanningAdminListPanel(JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Planning Admins");
    ...
    private void btnCreateEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEventActionPerformed
        ...
        PlanningAdmin item = (PlanningAdmin) model.getValueAt(idx, 0);
        if(item == null) {
            JOptionPane.showMessageDialog(this, "Not correct item");
            return;
        }

        UpdatePlanningAdminPanel panel = new UpdatePlanningAdminPanel(item,this.mainPanel,this.al);
        this.al.add(this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String msg = this.hs.deletePlanningAdmin(item.getId());
