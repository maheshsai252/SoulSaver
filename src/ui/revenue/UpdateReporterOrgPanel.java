 ...
 * @author maheshsai
 */
public class UpdateReporterOrgPanel extends javax.swing.JPanel {

    /**
     * Creates new form UpdateReporterOrgPanel
     */
      
 JSplitPane mainPanel;
    ArrayList<Component> al;
    ReporterOrg ro;
    public UpdateReporterOrgPanel(ReporterOrg ro,JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
        ...
        this.setSelectedValue(boxeps, ro.getRevenueep_id());
    }
...
void setSelectedValue(JComboBox comboBox, String value)
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        ro.setName(name);
        ro.setRevenueep_id(cid);
        String msg = new ReporterOrgService().update(ro);
