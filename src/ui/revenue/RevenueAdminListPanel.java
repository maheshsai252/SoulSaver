 ...
 * @author maheshsai
 */
public class RevenueAdminListPanel extends javax.swing.JPanel {

    /**
     * Creates new form RevenueAdminListPanel
     */
      JSplitPane mainPanel;
    ArrayList<Component> al;
    RevenueAdminService hs = new RevenueAdminService();
    public RevenueAdminListPanel(JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Revenue Admins");
    ...
    private void btnCreateEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEventActionPerformed
        ...
        RevenueAdmin item = (RevenueAdmin) model.getValueAt(idx, 0);
        if(item == null) {
            JOptionPane.showMessageDialog(this, "Not correct item");
            return;
        }

        UpdateRevenueAdminPanel panel = new UpdateRevenueAdminPanel(item,this.mainPanel,this.al);
        this.al.add(this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String msg = this.hs.deleteRevenueAdmin(item.getId());
