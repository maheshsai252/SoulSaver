 ...
 * @author maheshsai
 */
public class PharmaceuticalAdminListPanel extends javax.swing.JPanel {

    /**
     * Creates new form PharmaceuticalAdminListPanel
     */
  JSplitPane mainPanel;
    ArrayList<Component> al;
    PharmaceuticalAdminService hs = new PharmaceuticalAdminService();
    public PharmaceuticalAdminListPanel(JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Pharmaceutical Admins");
    ...
    private void btnCreateEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEventActionPerformed
        ...
        PharmaceuticalAdmin item = (PharmaceuticalAdmin) model.getValueAt(idx, 0);
        if(item == null) {
            JOptionPane.showMessageDialog(this, "Not correct item");
            return;
        }

        UpdatePharmaceuticalAdminPanel panel = new UpdatePharmaceuticalAdminPanel(item,this.mainPanel,this.al);
        this.al.add(this);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String msg = this.hs.deletePharmaceuticalAdmin(item.getId());
