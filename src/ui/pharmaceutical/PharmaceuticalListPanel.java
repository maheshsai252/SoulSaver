...
import ui.manufacturing_department.ManufacturingDepartmentListPanel;
import ui.pharmacy.PharmacyListPanel;
 ...
 * @author maheshsai
 */
public class PharmaceuticalListPanel extends javax.swing.JPanel {

    /**
     * Creates new form PharmaceuticalListPanel
     */
   
    JSplitPane mainPanel;
    ArrayList<Component> al;
    PharmaceuticalService hs = new PharmaceuticalService();
    public PharmaceuticalListPanel(JSplitPane mainPanel, ArrayList<Component> al) {
        initComponents();
    ...
    void addData() {
        ArrayList<Pharmaceutical> hospitals = hs.getAllPharmaceuticals();
        DefaultTableModel model = (DefaultTableModel) this.tblEncounters.getModel();

        model.setRowCount(0);
        
        for(Pharmaceutical h: hospitals) {
    ...
    private void initComponents() {
        ...
        btnCreateEvent1 = new javax.swing.JButton();
        ...
        btnCreateEvent.setText("View Pharmacies");
        ...
        btnCreateEvent1.setFont(new java.awt.Font("Helvetica Neue", 1, 12)); // NOI18N
        btnCreateEvent1.setForeground(new java.awt.Color(0, 0, 0));
        btnCreateEvent1.setText("View Manufacturing Departments");
        btnCreateEvent1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnCreateEvent1ActionPerformed(evt);
            }
        });
    ...
    private void btnCreateEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEventActionPerformed
        ...
        Pharmaceutical item = (Pharmaceutical) model.getValueAt(idx, 0);
        if(item == null) {
            JOptionPane.showMessageDialog(this, "Not correct item");
            return;
        }

        PharmacyListPanel panel = new PharmacyListPanel(item,this.mainPanel,this.al);
        this.al.add(this);
    ...
    private void btnViewEventActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnViewEventActionPerformed
        ...
        UpdatePharmaceuticalPanel panel = new UpdatePharmaceuticalPanel(item,this.mainPanel,this.al);
        this.al.add(this);
        this.mainPanel.setRightComponent(panel);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String msg = this.hs.deletePharmaceutical(item.getId());
        JOptionPane.showMessageDialog(this, msg);
        addData();
    }//GEN-LAST:event_jButton1ActionPerformed

    private void btnCreateEvent1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCreateEvent1ActionPerformed
        // TODO add your handling code here:
         int idx = this.tblEncounters.getSelectedRow();
        if(idx<0) {
            JOptionPane.showMessageDialog(this, "Not correct index");
        ...
        if(item == null) {
         ...
         ManufacturingDepartmentListPanel panel = new ManufacturingDepartmentListPanel(item,this.mainPanel,this.al);
        this.al.add(this);
        this.mainPanel.setRightComponent(panel);
    }//GEN-LAST:event_btnCreateEvent1ActionPerformed
    ...
    private javax.swing.JButton btnCreateEvent1;
